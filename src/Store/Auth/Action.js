...
export const loginUser=(loginData)=>async(dispatch)=>{
  try{
    const {data}=await axios.post(`${API_BASE_URL}/auth/signin`,loginData,{responseType: 'json'});
...
// export const updateUserProfile=(reqData)=>async(dispatch)=>{
//   try{
//     const {data}=await axios.put(`${API_BASE_URL}/api/users/update${reqData}`,reqData)
//     console.log("updated user: ",data)
